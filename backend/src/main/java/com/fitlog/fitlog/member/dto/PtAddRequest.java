...
public class PtAddRequest {
    ...
    private int sessions;           // 추가할 횟수 (첫 등록 시엔 총 결제 수)
    private Integer initialRemaining; // 첫 등록 시 현재 잔여 수 (null이면 sessions과 동일)
    ...
    public Integer getInitialRemaining() { return initialRemaining; }
    ...
    public void setInitialRemaining(Integer initialRemaining) { this.initialRemaining = initialRemaining; }
